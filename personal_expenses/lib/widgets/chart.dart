...
class Chart extends StatefulWidget {
  ...
  final Function onChartSelected;

  Chart(this.recentTransactions, this.onChartSelected);
          ...
          children: groupedTransactionValues.map((data) {
            return Flexible(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  setState(() {
                    if (selectedDateTime != null && selectedDateTime.day ==
                        (data['date'] as DateTime).day) {
                      selectedDateTime = null;
                    } else {
                      selectedDateTime = data['date'];
                    }
                  });

                  widget.onChartSelected(data['date']);
                },
                child: ChartBar(
                  data['day'],
                  (selectedDateTime != null &&
